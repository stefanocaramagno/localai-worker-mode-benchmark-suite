# C7 — Default Kubernetes Scheduler Baseline Report
...
This report summarizes the default-scheduler baseline campaign for distributed LocalAI tenant workloads. It combines performance measurements, tenant-level traffic evidence, runtime pod-to-node placement, placement classification and technical diagnosis context to determine whether Kubernetes default scheduling produces adequate or suboptimal placements under multi-tenancy, latency injection, variable worker-node count and differentiated tenant traffic.
...
|---|---|---|---|---|
| Default Kubernetes Scheduler Baseline | `DS_1T_4N_L0_UNIFORM_M1_W2` | DS_1T_4N_L0_UNIFORM_M1_W2 | measured | tenant count, worker-node count, latency profile, tenant traffic profile, model mix |

## Data sources

| Layer | Primary use | Source |
|---|---|---|
| Measurement CSV | Quantitative charts and scenario summary metrics | `{"default-scheduler": "results/experimental-cycles/C7/benchmark/default-scheduler"}` |
| Technical diagnosis | Interpretation, family judgments, findings, unsupported-scenario context | `results/experimental-cycles/C7/diagnosis/analysis_diagnosis_all_NA_20260619T174741Z_diagnosis.json` |
...
| Reporting output | Current generated report package | `results/experimental-cycles/C7/reporting` |
...
|---|---|---|---|---|---|---|---|---|---|
| `DS_1T_2N_L0_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_1T_2N_L1_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_1T_3N_L1_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_3W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_3W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | 3 | 8 vCPU | 16 GiB | ephemeral |
| `DS_1T_4N_L0_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_1T_4N_L1_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_1T_4N_L2_UNIFORM_M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_2N_L0_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_2N_L1_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_2W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_2W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | 2 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_3W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_3W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | 3 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_3N_L1_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_3W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_3W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | 3 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L0_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L0_UNIFORM_M1M2_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L1_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L1_UNIFORM_M1M2_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_2T_4N_L2_UNIFORM_M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_3T_4N_L0_UNIFORM_M1M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
| `DS_3T_4N_L1_UNIFORM_M1M1M1_W2` | default-scheduler | INFRA_C7_1CP_4W_8C16G | config/infrastructure/profiles/INFRA_C7_1CP_4W_8C16G.json | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | 4 | 8 vCPU | 16 GiB | ephemeral |
...
|---|---|---|---|---|---|---|---|
| `DS_1T_2N_L0_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_1T_2N_L1_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_1T_3N_L1_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-3w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-3w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-3w-8c16g/kubeconfig |
| `DS_1T_4N_L0_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_1T_4N_L1_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_1T_4N_L2_UNIFORM_M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_2T_2N_L0_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_2T_2N_L1_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_2W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-2w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-2w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-2w-8c16g/kubeconfig |
| `DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-3w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-3w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-3w-8c16g/kubeconfig |
| `DS_2T_3N_L1_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_3W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-3w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-3w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-3w-8c16g/kubeconfig |
| `DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L0_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L0_UNIFORM_M1M2_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L1_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L1_UNIFORM_M1M2_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_2T_4N_L2_UNIFORM_M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_3T_4N_L0_UNIFORM_M1M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
| `DS_3T_4N_L1_UNIFORM_M1M1M1_W2` | default-scheduler | proxmox-k3s | BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S | config/infrastructure/providers/proxmox-k3s/bindings/BINDING_INFRA_C7_1CP_4W_8C16G_PROXMOX_K3S.json | config/infrastructure/providers/proxmox-k3s/examples/cluster.c7-1cp-4w-8c16g.example.yaml | config/infrastructure/providers/proxmox-k3s/local/cluster.c7-1cp-4w-8c16g.local.yaml | config/cluster-access/generated/proxmox-k3s/c7-1cp-4w-8c16g/kubeconfig |
...
| Latest manifest | variant-scoped validation manifests (25 available) |
| Current status | variant-scoped validation available (25/25 validated) |
| Variant validation statuses | validated=25 |
| Latest raw validation | variant-scoped validation evidence is recorded in the campaign execution manifest and generated runtime profiles under results/experimental-cycles/C7/execution/generated-runtime-configs |
| Accepted provisioning statuses | completed |
| Required kubeconfig status | verified |
| Artifact root | results/experimental-cycles/C7/execution/generated-runtime-configs |
...
|---|---|---|---|---|---|---|---|---|
| `DS_1T_2N_L0_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_2N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L0_UNIFORM_M1_W2/TC_DS_1T_2N_L0_UNIFORM_M1_W2.json | AD_C7_DS_1T_2N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L0_UNIFORM_M1_W2/AD_DS_1T_2N_L0_UNIFORM_M1_W2.json | MO_C7_DS_1T_2N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L0_UNIFORM_M1_W2/MO_DS_1T_2N_L0_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_2N_L0_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_1T_2N_L1_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_2N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L1_UNIFORM_M1_W2/TC_DS_1T_2N_L1_UNIFORM_M1_W2.json | AD_C7_DS_1T_2N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L1_UNIFORM_M1_W2/AD_DS_1T_2N_L1_UNIFORM_M1_W2.json | MO_C7_DS_1T_2N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L1_UNIFORM_M1_W2/MO_DS_1T_2N_L1_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_2N_L1_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_1T_3N_L1_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_3N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_3N_L1_UNIFORM_M1_W2/TC_DS_1T_3N_L1_UNIFORM_M1_W2.json | AD_C7_DS_1T_3N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_3N_L1_UNIFORM_M1_W2/AD_DS_1T_3N_L1_UNIFORM_M1_W2.json | MO_C7_DS_1T_3N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_3N_L1_UNIFORM_M1_W2/MO_DS_1T_3N_L1_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_3N_L1_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_1T_4N_L0_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_4N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L0_UNIFORM_M1_W2/TC_DS_1T_4N_L0_UNIFORM_M1_W2.json | AD_C7_DS_1T_4N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L0_UNIFORM_M1_W2/AD_DS_1T_4N_L0_UNIFORM_M1_W2.json | MO_C7_DS_1T_4N_L0_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L0_UNIFORM_M1_W2/MO_DS_1T_4N_L0_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_4N_L0_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_1T_4N_L1_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_4N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L1_UNIFORM_M1_W2/TC_DS_1T_4N_L1_UNIFORM_M1_W2.json | AD_C7_DS_1T_4N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L1_UNIFORM_M1_W2/AD_DS_1T_4N_L1_UNIFORM_M1_W2.json | MO_C7_DS_1T_4N_L1_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L1_UNIFORM_M1_W2/MO_DS_1T_4N_L1_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_4N_L1_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_1T_4N_L2_UNIFORM_M1_W2` | default-scheduler | TC_C7_DS_1T_4N_L2_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L2_UNIFORM_M1_W2/TC_DS_1T_4N_L2_UNIFORM_M1_W2.json | AD_C7_DS_1T_4N_L2_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L2_UNIFORM_M1_W2/AD_DS_1T_4N_L2_UNIFORM_M1_W2.json | MO_C7_DS_1T_4N_L2_UNIFORM_M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L2_UNIFORM_M1_W2/MO_DS_1T_4N_L2_UNIFORM_M1_W2.json | results/experimental-cycles/C7/variants/DS_1T_4N_L2_UNIFORM_M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2/TC_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2/MO_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_2N_L0_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_2N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_UNIFORM_M1M1_W2/TC_DS_2T_2N_L0_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_2N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_UNIFORM_M1M1_W2/AD_DS_2T_2N_L0_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_2N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_UNIFORM_M1M1_W2/MO_DS_2T_2N_L0_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_2N_L0_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2/TC_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2/MO_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_2N_L1_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_2N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_UNIFORM_M1M1_W2/TC_DS_2T_2N_L1_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_2N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_UNIFORM_M1M1_W2/AD_DS_2T_2N_L1_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_2N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_UNIFORM_M1M1_W2/MO_DS_2T_2N_L1_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_2N_L1_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/TC_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/MO_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2/TC_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2/MO_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_3N_L1_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_3N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_UNIFORM_M1M1_W2/TC_DS_2T_3N_L1_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_3N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_UNIFORM_M1M1_W2/AD_DS_2T_3N_L1_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_3N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_UNIFORM_M1M1_W2/MO_DS_2T_3N_L1_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_3N_L1_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2/TC_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2/MO_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L0_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M1_W2/TC_DS_2T_4N_L0_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_4N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M1_W2/AD_DS_2T_4N_L0_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_4N_L0_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M1_W2/MO_DS_2T_4N_L0_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L0_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L0_UNIFORM_M1M2_W2` | default-scheduler | TC_C7_DS_2T_4N_L0_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M2_W2/TC_DS_2T_4N_L0_UNIFORM_M1M2_W2.json | AD_C7_DS_2T_4N_L0_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M2_W2/AD_DS_2T_4N_L0_UNIFORM_M1M2_W2.json | MO_C7_DS_2T_4N_L0_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M2_W2/MO_DS_2T_4N_L0_UNIFORM_M1M2_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L0_UNIFORM_M1M2_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2/TC_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2/MO_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2` | default-scheduler | TC_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2/TC_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2.json | AD_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2/AD_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2.json | MO_C7_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2/MO_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L1_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M1_W2/TC_DS_2T_4N_L1_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_4N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M1_W2/AD_DS_2T_4N_L1_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_4N_L1_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M1_W2/MO_DS_2T_4N_L1_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L1_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L1_UNIFORM_M1M2_W2` | default-scheduler | TC_C7_DS_2T_4N_L1_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M2_W2/TC_DS_2T_4N_L1_UNIFORM_M1M2_W2.json | AD_C7_DS_2T_4N_L1_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M2_W2/AD_DS_2T_4N_L1_UNIFORM_M1M2_W2.json | MO_C7_DS_2T_4N_L1_UNIFORM_M1M2_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M2_W2/MO_DS_2T_4N_L1_UNIFORM_M1M2_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L1_UNIFORM_M1M2_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/TC_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2.json | AD_C7_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2.json | MO_C7_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/MO_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_2T_4N_L2_UNIFORM_M1M1_W2` | default-scheduler | TC_C7_DS_2T_4N_L2_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_UNIFORM_M1M1_W2/TC_DS_2T_4N_L2_UNIFORM_M1M1_W2.json | AD_C7_DS_2T_4N_L2_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_UNIFORM_M1M1_W2/AD_DS_2T_4N_L2_UNIFORM_M1M1_W2.json | MO_C7_DS_2T_4N_L2_UNIFORM_M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_UNIFORM_M1M1_W2/MO_DS_2T_4N_L2_UNIFORM_M1M1_W2.json | results/experimental-cycles/C7/variants/DS_2T_4N_L2_UNIFORM_M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_3T_4N_L0_UNIFORM_M1M1M1_W2` | default-scheduler | TC_C7_DS_3T_4N_L0_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L0_UNIFORM_M1M1M1_W2/TC_DS_3T_4N_L0_UNIFORM_M1M1M1_W2.json | AD_C7_DS_3T_4N_L0_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L0_UNIFORM_M1M1M1_W2/AD_DS_3T_4N_L0_UNIFORM_M1M1M1_W2.json | MO_C7_DS_3T_4N_L0_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L0_UNIFORM_M1M1M1_W2/MO_DS_3T_4N_L0_UNIFORM_M1M1M1_W2.json | results/experimental-cycles/C7/variants/DS_3T_4N_L0_UNIFORM_M1M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2` | default-scheduler | TC_C7_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2/TC_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2.json | AD_C7_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2/AD_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2.json | MO_C7_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2/MO_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2.json | results/experimental-cycles/C7/variants/DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
| `DS_3T_4N_L1_UNIFORM_M1M1M1_W2` | default-scheduler | TC_C7_DS_3T_4N_L1_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_UNIFORM_M1M1M1_W2/TC_DS_3T_4N_L1_UNIFORM_M1M1M1_W2.json | AD_C7_DS_3T_4N_L1_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_UNIFORM_M1M1M1_W2/AD_DS_3T_4N_L1_UNIFORM_M1M1M1_W2.json | MO_C7_DS_3T_4N_L1_UNIFORM_M1M1M1_W2 | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_UNIFORM_M1M1M1_W2/MO_DS_3T_4N_L1_UNIFORM_M1M1M1_W2.json | results/experimental-cycles/C7/variants/DS_3T_4N_L1_UNIFORM_M1M1M1_W2/infrastructure/validation/latest-cluster-validation-manifest.json (validated) |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `DS_1T_2N_L0_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L0_UNIFORM_M1_W2/AD_DS_1T_2N_L0_UNIFORM_M1_W2.json |
| `DS_1T_2N_L1_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_2N_L1_UNIFORM_M1_W2/AD_DS_1T_2N_L1_UNIFORM_M1_W2.json |
| `DS_1T_3N_L1_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_3N_L1_UNIFORM_M1_W2/AD_DS_1T_3N_L1_UNIFORM_M1_W2.json |
| `DS_1T_4N_L0_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L0_UNIFORM_M1_W2/AD_DS_1T_4N_L0_UNIFORM_M1_W2.json |
| `DS_1T_4N_L1_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L1_UNIFORM_M1_W2/AD_DS_1T_4N_L1_UNIFORM_M1_W2.json |
| `DS_1T_4N_L2_UNIFORM_M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/single-tenant | infra/k8s/compositions/default-scheduler/single-tenant | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L2_EDGE_REMOTE | tenants=1; tenantIds=tenant-a; trafficProfile=TR_1T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_1T_4N_L2_UNIFORM_M1_W2/AD_DS_1T_4N_L2_UNIFORM_M1_W2.json |
| `DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_2N_L0_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L0_UNIFORM_M1M1_W2/AD_DS_2T_2N_L0_UNIFORM_M1M1_W2.json |
| `DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_2N_L1_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L1_UNIFORM_M1M1_W2/AD_DS_2T_2N_L1_UNIFORM_M1M1_W2.json |
| `DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L2_EDGE_REMOTE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/AD_DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_3N_L1_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_3N_L1_UNIFORM_M1M1_W2/AD_DS_2T_3N_L1_UNIFORM_M1M1_W2.json |
| `DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_4N_L0_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M1_W2/AD_DS_2T_4N_L0_UNIFORM_M1M1_W2.json |
| `DS_2T_4N_L0_UNIFORM_M1M2_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L0_UNIFORM_M1M2_W2/AD_DS_2T_4N_L0_UNIFORM_M1M2_W2.json |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2/AD_DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2.json |
| `DS_2T_4N_L1_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M1_W2/AD_DS_2T_4N_L1_UNIFORM_M1M1_W2.json |
| `DS_2T_4N_L1_UNIFORM_M1M2_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | infra/k8s/compositions/default-scheduler/two-tenants-mixed-models | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L1_UNIFORM_M1M2_W2/AD_DS_2T_4N_L1_UNIFORM_M1M2_W2.json |
| `DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L2_EDGE_REMOTE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/AD_DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2.json |
| `DS_2T_4N_L2_UNIFORM_M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/two-tenants | infra/k8s/compositions/default-scheduler/two-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L2_EDGE_REMOTE | tenants=2; tenantIds=tenant-a, tenant-b; trafficProfile=TR_2T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_2T_4N_L2_UNIFORM_M1M1_W2/AD_DS_2T_4N_L2_UNIFORM_M1M1_W2.json |
| `DS_3T_4N_L0_UNIFORM_M1M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/three-tenants | infra/k8s/compositions/default-scheduler/three-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L0_NONE | tenants=3; tenantIds=tenant-a, tenant-b, tenant-c; trafficProfile=TR_3T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L0_UNIFORM_M1M1M1_W2/AD_DS_3T_4N_L0_UNIFORM_M1M1M1_W2.json |
| `DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/three-tenants | infra/k8s/compositions/default-scheduler/three-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=3; tenantIds=tenant-a, tenant-b, tenant-c; trafficProfile=TR_3T_DIFFERENTIATED_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2/AD_DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2.json |
| `DS_3T_4N_L1_UNIFORM_M1M1M1_W2` | default-scheduler | DEFAULT_KUBERNETES_SCHEDULER | runtime_default_scheduler_decision | infra/k8s/compositions/default-scheduler/three-tenants | infra/k8s/compositions/default-scheduler/three-tenants | 2 | localai-rpc-a, localai-rpc-b | captured_at_runtime | captured_at_runtime | L1_EDGE_NEAR | tenants=3; tenantIds=tenant-a, tenant-b, tenant-c; trafficProfile=TR_3T_UNIFORM_LOW | results/experimental-cycles/C7/execution/generated-runtime-configs/DS_3T_4N_L1_UNIFORM_M1M1M1_W2/AD_DS_3T_4N_L1_UNIFORM_M1M1M1_W2.json |
...
|---|---|---|---|---|---|---|---|
| default-scheduler | DS_1T_2N_L0_UNIFORM_M1_W2 | measured | 3 | 1505.33 | 1766.67 | 0.1600 | NA |
| default-scheduler | DS_1T_2N_L1_UNIFORM_M1_W2 | measured | 3 | 7738.62 | 8766.67 | 0.0821 | NA |
| default-scheduler | DS_1T_3N_L1_UNIFORM_M1_W2 | measured | 3 | 16152.41 | 19666.67 | 0.0496 | NA |
| default-scheduler | DS_1T_4N_L0_UNIFORM_M1_W2 | measured | 3 | 1517.72 | 1633.33 | 0.1597 | NA |
| default-scheduler | DS_1T_4N_L1_UNIFORM_M1_W2 | measured | 3 | 16297.94 | 20666.67 | 0.0493 | NA |
| default-scheduler | DS_1T_4N_L2_UNIFORM_M1_W2 | measured | 3 | 47306.80 | 51666.67 | 0.0202 | NA |
| default-scheduler | DS_2T_2N_L0_DIFFERENTIATED_M1M1_W2 | measured | 6 | 1513.05 | 1700.00 | 0.1272 | NA |
| default-scheduler | DS_2T_2N_L0_UNIFORM_M1M1_W2 | measured | 6 | 1620.39 | 1750.00 | 0.1575 | NA |
| default-scheduler | DS_2T_2N_L1_DIFFERENTIATED_M1M1_W2 | measured | 6 | 11567.60 | 12183.33 | 0.0626 | NA |
| default-scheduler | DS_2T_2N_L1_UNIFORM_M1M1_W2 | measured | 6 | 13000.65 | 15516.67 | 0.0616 | NA |
| default-scheduler | DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2 | unsupported_under_current_constraints | 0 | NA | NA | NA | application_not_ready,localai_deployment,smoke_validation_failure |
| default-scheduler | DS_2T_3N_L1_DIFFERENTIATED_M1M1_W2 | measured | 6 | 15545.31 | 17833.33 | 0.0466 | NA |
| default-scheduler | DS_2T_3N_L1_UNIFORM_M1M1_W2 | measured | 6 | 16516.88 | 19500.00 | 0.0487 | NA |
| default-scheduler | DS_2T_4N_L0_DIFFERENTIATED_M1M1_W2 | measured | 6 | 1567.36 | 2200.00 | 0.1263 | NA |
| default-scheduler | DS_2T_4N_L0_UNIFORM_M1M1_W2 | measured | 6 | 1522.58 | 1633.33 | 0.1596 | NA |
| default-scheduler | DS_2T_4N_L0_UNIFORM_M1M2_W2 | measured | 6 | 1503.98 | 1583.33 | 0.1601 | NA |
| default-scheduler | DS_2T_4N_L1_DIFFERENTIATED_M1M1_W2 | measured | 6 | 15552.15 | 17333.33 | 0.0466 | NA |
| default-scheduler | DS_2T_4N_L1_DIFFERENTIATED_M1M2_W2 | measured | 6 | 15666.94 | 17833.33 | 0.0463 | NA |
| default-scheduler | DS_2T_4N_L1_UNIFORM_M1M1_W2 | measured | 6 | 16222.40 | 19500.00 | 0.0494 | NA |
| default-scheduler | DS_2T_4N_L1_UNIFORM_M1M2_W2 | measured | 6 | 16106.63 | 19666.67 | 0.0496 | NA |
| default-scheduler | DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2 | unsupported_under_current_constraints | 0 | NA | NA | NA | application_not_ready,localai_deployment,smoke_validation_failure |
| default-scheduler | DS_2T_4N_L2_UNIFORM_M1M1_W2 | measured | 6 | 50644.42 | 53666.67 | 0.0195 | NA |
| default-scheduler | DS_3T_4N_L0_UNIFORM_M1M1M1_W2 | measured | 9 | 1587.79 | 1711.11 | 0.1582 | NA |
| default-scheduler | DS_3T_4N_L1_DIFFERENTIATED_M1M1M1_W2 | measured | 9 | 15578.70 | 17000.00 | 0.0436 | NA |
| default-scheduler | DS_3T_4N_L1_UNIFORM_M1M1M1_W2 | measured | 9 | 16279.21 | 18666.67 | 0.0494 | NA |
...
| Metric | Value | Source |
|---|---|---|
| request_count | 9.5048 | scenario summary aggregation fallback |
| success_rate_percent | 100.0 | scenario summary aggregation fallback |
| failure_count | 0 | scenario summary aggregation fallback |
| mean_response_time_ms | 13152.8204 | scenario summary aggregation fallback |
| p50_response_time_ms | 12513.6811 | scenario summary aggregation fallback |
| p95_response_time_ms | 14932.3672 | scenario summary aggregation fallback |
| p99_response_time_ms | 14932.3672 | scenario summary aggregation fallback |
| throughput_rps | 0.0841 | scenario summary aggregation fallback |
| max_node_cpu_percent | 4.4493 | scenario summary aggregation fallback |
| max_node_memory_percent | 15.9855 | scenario summary aggregation fallback |
| max_pod_cpu_millicores | 232.8551 | scenario summary aggregation fallback |
...
| kubernetes_events_count | 24.8261 | scenario summary aggregation fallback |
| kubernetes_warning_events_count | 0.0435 | scenario summary aggregation fallback |

## Unsupported Scenario Summary

| Family | Scenario | Status | Evidence | Source |
|---|---|---|---|---|
| default-scheduler | DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2 | unsupported_under_current_constraints | application_not_ready, localai_deployment, smoke_validation_failure | results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2_runA_unsupported.json, results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2_runB_unsupported.json, results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_2N_L2_DIFFERENTIATED_M1M1_W2_runC_unsupported.json |
| default-scheduler | DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2 | unsupported_under_current_constraints | application_not_ready, localai_deployment, smoke_validation_failure | results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2_runA_unsupported.json, results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2_runB_unsupported.json, results/experimental-cycles/C7/benchmark/default-scheduler/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2/DS_2T_4N_L2_DIFFERENTIATED_M1M1_W2_runC_unsupported.json |

## Main Findings

| Family | Finding | Status | Confidence | Implication |
|---|---|---|---|---|
| default-scheduler | The default-scheduler family provides direct negative placement evidence. | suboptimal_placement_signal_available | high | The captured scheduler decisions include warning or critical placement categories, supporting the claim that default Kubernetes placement can become inadequate for distributed GenAI tenant workloads. |
| default-scheduler | Default-scheduler decision evidence is available for at least one C7 scenario. | NA | high | The diagnosis can interpret runtime pod-to-node assignments instead of relying only on benchmark latency and throughput metrics. |
| default-scheduler | At least one default-scheduler scenario produced warning or critical placement-classification evidence. | NA | high | Warning or critical placement categories provide direct evidence that formally valid default-scheduler placements may be suboptimal for the observed GenAI workload topology. |
...
|---|---|---|---|---|
| Default Kubernetes Scheduler Baseline | [default-scheduler](sweeps/default-scheduler/index.html) | partially_measured | measured=23, unsupported=2, missing=0 | tenant count, worker-node count, latency profile, tenant traffic profile, model mix |

## Diagnosis coverage snapshot

| Family | Scenarios | Observed | Measured | Unsupported | Samples |
|---|---|---|---|---|---|
| default-scheduler | 25 | 25 | 23 | 2 | 129 |
...
> C7 reports runtime default-scheduler behavior; pod placement must be interpreted from captured scheduler evidence rather than from predefined node assignments.
...
> Comparative claims should combine performance metrics with placement classification, latency profile and resource-pressure evidence.
