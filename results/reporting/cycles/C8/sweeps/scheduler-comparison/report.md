# C8 — Scheduler Comparison Sweep Report

**Cycle ID:** `C8`
**Sweep:** `scheduler-comparison`
...
This sweep-specific report isolates **Scheduler Comparison** so that the varied dimension, fixed dimensions, measured values, unsupported evidence and diagnosis-based reading can be inspected without navigating the full consolidated report.
